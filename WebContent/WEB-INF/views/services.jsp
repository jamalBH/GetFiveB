                  ...
                  <th>Status</th>
             	  ...
             	  <tr>
             	   ...
             	   <td>${l.chambre.n_chambre}</td>
					 ...
					 <td>${l.date}</td>
                  <td>
                    <a class="btn btn-success"  onclick="sendValide('${l.client.user}')" href="validerService?idcmd=${l.id_commande}">Valider</a> 
                    <a class="btn btn-danger"  onclick="sendAnnule('${l.client.user}')" href="annulerService?idcmd=${l.id_commande}">Annuler</a> 
